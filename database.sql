...
CREATE INDEX IF NOT EXISTS idx_checkins_session_created ON checkins(session_id, created_at);
CREATE INDEX IF NOT EXISTS idx_share_clicks_session_created ON share_clicks(session_id, created_at);
